...
class ProfessionSeeder extends Seeder
{
    ...
    public function run()
    {
            ...
            $items = [
                ['id' => 1, 'name' => 'No Education'],
                ['id' => 2, 'name' => 'Below 10th Class'],
                ['id' => 3, 'name' => '10th Pass'],
                ['id' => 4, 'name' => 'Inter/ITI/Polytechnic'],
                ['id' => 5, 'name' => 'Degree/B.Tech/B.E/MBBS'],
                ['id' => 6, 'name' => 'P.G/M.Tech/M.E/MD/MS/Ph.D'],
        ...
        foreach ($items as $item) {
            \App\Models\ProfileRelated\Profession::create($item);
        };
